...
//% weight=115 icon="\uf0e7" color=#d2691e block="電気の利用"
namespace PSW {

    /**
     * 自動スイッチをオンにします。
     */
    //% blockId=turn_on block="スイッチ オン"
    //% weight=90
    //% group="スイッチ"
     ...
     * 自動スイッチをオフにします。
     */
    //% blockId=turn_off block="スイッチ オフ"
    //% weight=80
    //% group="スイッチ"
    ...
    /**
     * 明るさセンサーがしきい値より暗い（または明るい）場合に真を返します。
...
//        return _light_level_lux()
    ...
    /**
     * 温度[℃]を返します。
     * @param format 整数か小数かを指定します, eg: OutputNumberFormat.INTEGER
     */
